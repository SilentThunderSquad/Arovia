...
export const router = createBrowserRouter([
  ...
  { path: '/dashboard/user/address',            element: <RoleGuard requiredRole="user"><UserDashboard /></RoleGuard> },
  ...
  { path: '/dashboard/admin/overview',          element: <RoleGuard requiredRole="admin"><AdminDashboard /></RoleGuard> },
  { path: '/dashboard/admin/users',             element: <RoleGuard requiredRole="admin"><AdminDashboard /></RoleGuard> },
  { path: '/dashboard/admin/admins',            element: <RoleGuard requiredRole="admin"><AdminDashboard /></RoleGuard> },
  { path: '/dashboard/admin/doctors',           element: <RoleGuard requiredRole="admin"><AdminDashboard /></RoleGuard> },
  { path: '/dashboard/admin/analytics',         element: <RoleGuard requiredRole="admin"><AdminDashboard /></RoleGuard> },
