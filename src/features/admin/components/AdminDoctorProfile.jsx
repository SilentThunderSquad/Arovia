...
import { Avatar, Box, CircularProgress, Container, Divider, Grid, IconButton, Paper, Typography } from '@mui/material';
import { AccessTime, ArrowBack, AttachMoney, Business, Healing, Language, LocationOn, LocalHospital, Phone, School, Star } from '@mui/icons-material';
...
const AdminDoctorProfile = () => {
    ...
    const fetchDoctorData = useCallback(async () => {
        try {
            ...
            const data = await adminService.getDoctorByName(doctorName);
            if (!data) {
                Swal.fire('Not Found', 'Doctor profile not found', 'warning').then(() => navigate('/dashboard/admin'));
                return;
            }
            setDoctorInfo(data);
        } catch (error) {
